...
variable "toolchain" {
  ...
  validation {
    ...
    error_message = "toolchain sha256 pins (nvm_install_sha256, aws_cli_install_sha256, paseo_cli_tarball_sha256) must each be a full 64-hex SHA-256 value; replace the example placeholders before planning."
  }
  validation {
